...
type LetExpression struct {
	Token    lexer.Token
	Name     *ObjectIdentifier // First binding name
	Type     *TypeIdentifier   // First binding type
	Init     Expression        // First binding initialization (optional)
	Bindings []*Binding        // Additional bindings
	Body     Expression        // Expression after 'in'
}
...
type MethodCall struct {
	Token     lexer.Token
	Object    Expression
	Type      *TypeIdentifier  // Optional type annotation after @
